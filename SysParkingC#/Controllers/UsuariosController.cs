...
namespace SysParkingC_.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(SysParkingC_Context context)
        {
            _context = context;
        }
        ...
        {
            var sysParkingC_Context = _context.Usuario.Include(u => u.Estacionamento);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SysParkingC_Context.Usuario'  is null.");
            }
            var usuario = await _context.Usuario.FindAsync(id);
            if (usuario != null)
            {
